...
class QuickSortBenchmark
{
    ...
    static void Main()
    {
        ...
        for (int s = 0; s < sizes.Length; s++)
        {
            ...
            for (int i = 0; i < 10; i++) // Running 10 times for averaging
            {
                int[] arr = new int[size];
                for (int j = 0; j < size; j++)
                    arr[j] = rand.Next(1, size);
